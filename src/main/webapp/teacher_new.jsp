...
<head>
	...
	<style>
		/* Reuse same CSS from student.jsp here for consistency */
		/* You can externalize it into a .css file later */
		:root {
			--bg: #f4f6f8;
			--text: #333;
			--card: #fff;
		...
		/* ...Same styles as student.jsp: body, .sidebar, .main, .card, etc... */
		html { transition: background 0.4s, color 0.4s; }
		/* Copy full CSS from student page here */
	</style>
</head>
<body>
<div class="sidebar" id="sidebar">
	<h2>Teacher Menu</h2>
	<a href="teacher_profile.jsp">My Profile</a>
	<a href="manage_courses.jsp">Manage Courses</a>
	<a href="grade_submissions.jsp">Grade Submissions</a>
	<a href="attendance_tracker.jsp">Track Attendance</a>
...
<div class="main">
	...
	<div class="dashboard-container">
		<div class="card">
			...
			<a href="teacher_profile.jsp">View Profile</a>
		</div>
